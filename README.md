...
Serverbefund, Host-Härtung, Erstinstallation, Deployment, Rollback, Backup und Wiederherstellung sowie die Einrichtung der Google-OAuth-App sind in [docs/betrieb.md](docs/betrieb.md) und docs/betrieb/ beschrieben; die Kurzform des Deployments steht in docs/betrieb/deployment.md, die GitHub-Anbindung in docs/betrieb/github-deploy.md. Bedienung und Konfiguration: docs/anleitungen/. Störungen: docs/betrieb/runbook.md.
