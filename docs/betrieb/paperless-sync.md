...
| `paperless.archive_for_unsupported` | true | Ist das Original für die Verarbeitung ungeeignet (E-Mail, Office-Altformat, HTML), wird die PDF-Archivfassung übernommen, die Paperless beim Eingang mit Tika und Gotenberg erzeugt hat; aus: Original übernehmen, es entsteht ein Fall „nicht unterstütztes Format". Bestand nachziehen: Deploy-Aktion `paperless-archivfassung` (Auswahl über die Paperless-Verknüpfung, auch für Drive-Bestandsdateien, die per Prüfsumme verknüpft wurden) |
