...
| `reconcile-all` | Ordnerabgleich aller aktiven Objekte als echter Lauf; legt fehlende Struktur an, etwa die Unterordner der Stammakte nach der Katalogerweiterung | nichts |
