...
| T11 | Logging | JSON je Zeile, keine IBAN in Logs | JSON-Logs mit Maskierung (M1), Prüfabfrage | teilweise am 11.09.2026: 0 IBAN-Treffer in 2.000 Zeilen je Dienst; Web-Meldungen als JSON; Worker-Meldungen waren Text, weil Celery den Root-Logger übernahm; behoben mit `CELERY_WORKER_HIJACK_ROOT_LOGGER = False`, Nachprüfung nach dem nächsten Deployment | 11.09.2026, Aktion `deploy-tests` | Lauf 34598173584 |
...
Definition of Done für den Betriebsteil: T1 bis T14 bestanden und dokumentiert, Serverbefund abgelegt, Runbook vorhanden, Wiederherstellungsprotokoll vorhanden. Stand am 11.09.2026: T1, T2, T3, T14 bestanden, T11 teilweise, T4 bis T10, T12, T13 ausstehend; Serverbefund abgelegt (docs/betrieb/serverbefund.md), Runbook vorhanden (docs/betrieb.md), Wiederherstellungsprotokoll ausstehend (T6).
