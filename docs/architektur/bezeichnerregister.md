...
Modell `crm_api.CrmApiToken`. crm api tokens.
...
| updated_at | datetime(6) | nein |  |
| name | varchar(80) | nein |  |
| token_hash | varchar(64) | nein |  |
| scopes | json | nein |  |
| is_active | tinyint(1) | nein |  |
| last_used_at | datetime(6) | ja |  |
| revoked_at | datetime(6) | ja |  |
...
| sync.paperless_field_fill | Feld MHV Objekt aus Paperless-Speicherpfad gesetzt |
