...
Konfidenz: 0,9 oder höher nur, wenn Kategorie und Unterart eindeutig aus dem Text folgen. Bist du unsicher, wähle "06" mit Unterordner "01" und Konfidenz höchstens 0,6. Verwende ausschließlich die Codes der übergebenen Taxonomie. Trage in category, subfolder und document_type nur den Code ein (zum Beispiel "04"), niemals den Namen oder die ganze Zeile. Nenne in mentioned_units Einheitenbezeichnungen und in mentioned_parties Namen genau so, wie sie im Text stehen; der Abgleich erfolgt lokal. Gib das Abrechnungs- oder Wirtschaftsjahr, den Zeitraum und das Dokumentdatum an, wenn sie im Text stehen. Antworte nur im vorgegebenen JSON-Schema."""
